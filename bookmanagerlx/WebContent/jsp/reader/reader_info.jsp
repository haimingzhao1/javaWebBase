    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <table class="table table-hover">
                ...
                <tr>
                    <th>生日</th>
                    <td><fmt:formatDate value="${readerinfo.birth}"/></td>
                </tr>
                <tr>
                    <th>地址</th>
        ...
        <a class="btn btn-success btn-sm" href="${pageContext.request.contextPath}/reader?methodName=toEditReaderInfo&readerId=${readerinfo.readerid}" role="button">修改</a>
    </div>
</div>
