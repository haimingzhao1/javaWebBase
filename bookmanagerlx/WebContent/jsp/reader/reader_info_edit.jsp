...
<div class="col-xs-5 col-md-offset-3">
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <form action="${pageContext.request.contextPath}/reader" method="post" id="edit" >
            <input type="hidden" name="methodName" value="EditReaderInfo"/>
                ...
                <div class="input-group">
                    ...
                    <input type="text" class="form-control" name="birth" id="birth"  value='<fmt:formatDate value="${readerinfo.birth}"/>' >
                </div>
                <div class="input-group">
