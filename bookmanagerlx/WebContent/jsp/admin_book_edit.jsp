    ...
    <div class="panel panel-primary">
        ...
        <div class="panel-body">
            <form action="${pageContext.request.contextPath}/admin" method="post" id="addbook" >
				<input type="hidden" name="methodName" value="updateBook"/>
                ...
                <div class="input-group">
                    ...
                    <input type="text" class="form-control" name="pubdate" id="pubdate" value='<fmt:formatDate value="${detail.pubdate}"/>'>
                </div>
                <div class="input-group">
