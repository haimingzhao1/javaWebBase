    ...
    <script>
        ...
        $("#loginButton").click(function () {
            ...
            if (id == '') {
                ...
                $.ajax({
                    type: "POST",
                    url: "${pageContext.request.contextPath}/logonServlet",
                    data: {
                        id:id ,
                        passwd: passwd
                    },
                    ...
                    success: function(data) {
                        if (data.stateCode.trim() === "0") {
                            ...
                            window.location.href="${pageContext.request.contextPath}/admin?methodName=toAdminMain";
                            ...
                            $("#info").text("提示:登陆成功，跳转中...");
                            window.location.href="${pageContext.request.contextPath}/reader?methodName=toReaderMain";
